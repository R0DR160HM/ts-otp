...
describe(Result.name, () => {
    ...
    test(`${Result.Ok.name} should store a value`, () => {
        const value = 42;
    ...
    test(`${Result.Error.name} should store a detail`, () => {
        const detail = 'error';
    ...
    describe(Result.from.name, () => {
        ...
        test('should return an Ok instance if the operation is successful', () => {
            const value = 42;
        ...
        test('should return an Error instance if the operation throws an error', () => {
            const detail = 'error';
